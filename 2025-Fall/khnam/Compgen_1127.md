...
* **Screening Strategy:**
    1.  **Keyword Search:** Primary screening for the presence of Key Enzymes involved in the 20 amino acid biosynthetic pathways.
    2.  **GapMind Validation:** Rigorous verification of rate-limiting steps and subunit deletions (e.g., *ilvH*, *hisE*, *tyrB*) to confirm functional status beyond simple gene presence.
...
| **Valine / Ile** | Acetolactate synthase small (`ilvH`) | **0 (0%)** | 🔴 **Auxotroph** | **Large subunit only; functional loss** |
